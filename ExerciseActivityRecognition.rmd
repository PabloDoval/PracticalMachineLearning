...
A set of 20 files will be generated automatically as a sub-product of this study in order to evaluate the prediction of the model and assess the results for the course.
